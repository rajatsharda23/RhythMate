const ArtistDisplay = (topArtist) => {
  ...
  return (
    <div className="relative flex flex-col font-readex p-2 m-4">
        <div className='flex flex-row items-center p-3 '>1.
        ...
        <div className='flex flex-row items-center p-3'>2.
            <div className="pl-3 h-[30%] w-[30%]">
        ...
        <div className='flex flex-row items-center p-3'>3.
            <div className="pl-3 h-[30%] w-[30%]">
        ...
        <div className='flex flex-row items-center p-3'>4.
            <div className="pl-3 h-[30%] w-[30%]">
